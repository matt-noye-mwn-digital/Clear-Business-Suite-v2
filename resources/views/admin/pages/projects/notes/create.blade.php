...
@section('content')
    ...
    />
    {{ Breadcrumbs::render('admin-projects-notes-create', $project) }}
    <x-admin.errors/>
    <section class="pageMain">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.projects.notes.store', ['id' => $project->id]) }}" method="post">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-12">
