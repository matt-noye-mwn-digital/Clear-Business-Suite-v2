                                    ...
                                    <tfoot style="background-color: #fff; border-bottom: 0;">
                                        <tr style="background-color: #fff; border-bottom: 0;">
                                            ...
                                            <td class="d-flex justify-content-end" style="background-color: #fff; border-bottom: 0;">
                                                <button type="button" onclick="addRow()" class="mediumBlueBtn mt-2">Add Item</button>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <input type="number" name="invoice_discount" id="invoice_discount" step="any" value="{{ old('invoice_discount') }}">
